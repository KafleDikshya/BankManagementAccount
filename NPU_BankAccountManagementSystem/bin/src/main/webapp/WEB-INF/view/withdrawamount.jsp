...
<html lang="en">
    ...
    <body>
        ...
        <!--                            <img src="${pageContext.request.contextPath}/resources/images/logo.png" id="icon" alt="User Icon" />-->
                                    Enter account number of customer to withdraw account.
                                ...
                                <form:form method="POST" modelAttribute="account" action="processwithdraw">
                                    <form:input id="login" class="fadeIn second" placeholder="ACCOUNT NUMBER" path="accNember"/>
                                    <form:input id="login" class="fadeIn second" placeholder="AMOUNT TO WITHDRAW" path="accBalance"/>
