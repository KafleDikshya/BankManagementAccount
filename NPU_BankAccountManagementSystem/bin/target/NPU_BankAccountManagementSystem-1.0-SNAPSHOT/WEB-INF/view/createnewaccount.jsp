            ...
            <div class="row" id="main" >
                    ...
                    <!-- Icon -->
                        ...
                        <form:form id="regForm" modelAttribute="account" action="processNewAccount" method="POST">
                           <form:input path="accNember" class="fadeIn second" placeholder="ACCOUNT NUMBER" name="accountNumber"/>
                            <form:input path="accName" class="fadeIn second" placeholder="ACCOUNT NAME" name="name"/>
                            <form:input path="accBalance" class="fadeIn second" placeholder="OPENING BALANCE" name="balance"/>
