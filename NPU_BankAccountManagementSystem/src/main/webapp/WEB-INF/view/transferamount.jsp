...
<form:form method="POST" action="processfundtransfer" modelAttribute="fundtransferhelper">
                                ...
                                <form:input id="login" class="fadeIn second" placeholder="SOURCE ACCOUNT NUMBER" path="saccNo"/>
                                <form:input id="login" class="fadeIn second" placeholder="TARGET ACCOUNT NUMBER" path="raccNo"/>
