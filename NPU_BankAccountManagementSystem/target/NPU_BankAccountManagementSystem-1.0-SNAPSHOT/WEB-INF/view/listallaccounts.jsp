<%@page import="com.mycompany.domain.Accounts"%>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                ...
                <% ArrayList<Accounts> userList=(ArrayList<Accounts>) request.getAttribute("aList");
                    Iterator<Accounts> iter = userList.iterator();
                    System.out.println("Hello");
                    while(iter.hasNext()){
                     Accounts accnt = iter.next();
                %>
                     <tr>
                        <td><%out.print(accnt.getAccNember());%></td>
                        <td><%out.print(accnt.getAccName());%></td>
           
                        <td><%out.print(accnt.getAccBalance());%></td>
